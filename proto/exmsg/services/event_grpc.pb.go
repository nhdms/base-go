...
const (
	EventService_GetEvents_FullMethodName = "/exmsg.services.EventService/GetEvents"
)
...
func (c *eventServiceClient) GetEvents(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EventResponse, error) {
...
func (UnimplementedEventServiceServer) GetEvents(context.Context, *EventRequest) (*EventResponse, error) {
...
func _EventService_GetEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).GetEvents(ctx, req.(*EventRequest))
	}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "exmsg.services.EventService",

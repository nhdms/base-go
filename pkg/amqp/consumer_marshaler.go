...
func (d AQMPMarshaler) Marshal(msg *message.Message) (amqp.Publishing, error) {
...
func (d AQMPMarshaler) Unmarshal(amqpMsg amqp.Delivery) (*message.Message, error) {
	...
	msg.Metadata["exchange"] = amqpMsg.Exchange
	msg.Metadata["routing_key"] = amqpMsg.RoutingKey
	msg.Metadata["app_id"] = amqpMsg.AppId

	return msg, nil
}

func (d AQMPMarshaler) unmarshalMessageUUID(amqpMsg amqp.Delivery) (string, error) {
...
func (d AQMPMarshaler) computeMessageUUIDHeaderKey() string {
